...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([["datos.json",new URL("./files/datos_ffrustrados_año",import.meta.url)]]);
  main.builtin("FileAttachment", runtime.fileAttachments(name => fileAttachments.get(name)));
  main.variable(observer()).define(["md"], function(md){return(
md`# Femicidios frustrados hacia la mujer por año
...
FileAttachment("datos.json").json()
)});
  main.variable().define("partition", ["d3"], function(d3){return(
data => {
