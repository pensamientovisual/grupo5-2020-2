export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([[".csv",new URL("./files/aec3792837253d4c6168f9bbecdf495140a5f9bb1cdb12c7c8113cec26332634a71ad29b446a1e8236e0a45732ea5d0b4e86d9d1568ff5791412f093ec06f4f1",import.meta.url)]]);
...
main.variable(observer("data")).define("data", ["FileAttachment"], function(FileAttachment){return(
  FileAttachment("data - Hoja 1.csv").csv({typed: true})
  )});
